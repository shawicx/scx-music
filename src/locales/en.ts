export default {
  ...
  settings: {
    ...
    cacheManagement: {
      ...
      confirm: {
        ...
        coverBody: 'Delete {count} cached cover files? They will be re-extracted from audio files on next playback. Continue?',
        confirmBtn: 'Cleanup',
      },
    },
    // Startup options
  ...
  toast: {
    ...
    coverCacheCleared: 'Cleared {count} cover cache files',
