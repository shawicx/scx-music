  ...
  settings: {
    ...
    shortcuts: {
      ...
      action: {
        ...
        'app.mini-player': 'Enter / exit mini player',
        'app.desktop-lyrics': 'Show / hide desktop lyrics',
        'app.toggle-window': 'Show / hide main window',
        'app.cycle-mode': 'Cycle playback mode',
      },
      capture: {
