...
const { config: desktopLyricsConfig, locked: desktopLyricsLocked, toggle: toggleDesktopLyrics, toggleLock: toggleDesktopLyricsLock, updateConfig: updateDesktopLyricsConfig } = useDesktopLyrics()
