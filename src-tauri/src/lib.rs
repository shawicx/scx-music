...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            audio::analyzer_stop,
            audio::player_list_eq_presets,
            audio::player_get_eq,
            audio::player_set_eq_preset,
            audio::player_set_eq_enabled,
            ...
            commands::playlists::replace_playlist_songs,
            ...
            commands::stats::stats_dashboard,
